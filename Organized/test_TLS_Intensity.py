...
try:
    ...
    photon_J = hc/TLS_lam # individual photon energy
    absorbed_J = aper_time*watts # energy arriving in the total integration time
    photons = np.divide(absorbed_J, photon_J) # photons arriving in the integration time
